  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div v-else class="space-y-4">
      <div
        ...
        :key="dataset.id"
        class="card relative"
        :class="{ 'border-blue-500 border-2': dataset.isActive }"
      >
        <div
          v-if="dataset.isActive"
          class="absolute -top-3 left-4 px-2 py-1 bg-blue-500 text-white text-xs font-medium rounded-full"
        >
          Active
        </div>
        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p v-if="dataset.description" class="text-sm text-secondary">
                  {{ dataset.description }}
                </p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-2 mt-3">
              <span class="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-secondary text-xs rounded"
                >Quality: {{ dataset.defaultQuality }}</span
              >
              <span class="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-secondary text-xs rounded"
                >Category: {{ dataset.defaultCategory }}</span
              >
            </div>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <button
              class="p-2 text-secondary hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
              title="Edit"
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-2">
              ...
              <label for="autoApprove" class="text-sm text-gray-700 dark:text-gray-200"
                >Auto-approve imported examples</label
              >
            </div>
          </div>
        ...
        <div class="text-center">
          ...
          <p class="text-sm text-red-600 dark:text-red-400 mb-4">
            <span v-if="datasetToDelete?.sampleCount > 0"
              >This will permanently delete {{ datasetToDelete?.sampleCount }} sample(s). This
