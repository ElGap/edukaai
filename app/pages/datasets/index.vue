<template>
  <div class="max-w-6xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold mb-2">Manage Datasets</h1>
          ...
          <div class="flex-1">
            <div class="mb-2">
              <NuxtLink
                ...
                class="text-lg font-semibold hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
              >
                {{ dataset.name }}
              </NuxtLink>
              ...
              <p
                ...
                class="text-sm text-gray-700 dark:text-gray-300 font-medium mt-1"
              >
                🎯 {{ dataset.goalName }}
              </p>
            </div>
