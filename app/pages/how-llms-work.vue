<template>
  <div class="max-w-6xl mx-auto pb-20">
    ...
    <div class="text-sm text-tertiary mb-6">
      <NuxtLink to="/" class="hover:text-blue-600">← Back to Dashboard</NuxtLink>
    </div>
    ...
    <section id="what-is-llm" class="mb-12">
      ...
      <div class="card">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl mb-6">
          <div class="space-y-2 font-mono text-sm text-secondary">
    ...
    <section id="tokens" class="mb-12">
      ...
      <div class="card">
        ...
        <h3 class="text-lg font-semibold mb-4 text-blue-700 dark:text-blue-400">Why Tokens?</h3>
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1 p-3 bg-green-100 dark:bg-green-900/30 rounded-lg">
                ...
                <p class="text-xs text-secondary">"on" = 45%, "down" = 30%, "there" = 15%, ...</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="transformers" class="mb-12">
      ...
      <div class="card">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl mb-6">
          <h4 class="font-medium text-blue-900 dark:text-blue-100 mb-4">How It Works</h4>
          ...
          <div class="space-y-4">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <ul class="list-disc list-inside ml-4 space-y-1 text-sm text-secondary">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl">
          <div class="space-y-3">
            <div class="flex items-center gap-3">
              <div class="w-24 text-right text-xs text-tertiary">Layer 1</div>
              <div class="flex-1 h-8 bg-blue-200 dark:bg-blue-800 rounded flex items-center px-3">
                <span class="text-xs">Basic word relationships, syntax</span>
              </div>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-24 text-right text-xs text-tertiary">Layer 12</div>
              <div class="flex-1 h-8 bg-blue-300 dark:bg-blue-700 rounded flex items-center px-3">
                <span class="text-xs">Phrase meanings, local context</span>
              </div>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-24 text-right text-xs text-tertiary">Layer 24</div>
              <div class="flex-1 h-8 bg-blue-400 dark:bg-blue-600 rounded flex items-center px-3">
                <span class="text-xs text-white">Sentences, reasoning steps</span>
              </div>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-24 text-right text-xs text-tertiary">Layer 48</div>
              <div class="flex-1 h-8 bg-blue-600 dark:bg-blue-500 rounded flex items-center px-3">
                <span class="text-xs text-white">High-level concepts, document structure</span>
              </div>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-24 text-right text-xs text-tertiary">Final</div>
              <div class="flex-1 h-8 bg-green-500 dark:bg-green-600 rounded flex items-center px-3">
    ...
    <section id="quantization" class="mb-12">
      ...
      <div class="card">
          ...
          <table class="w-full text-sm mb-6">
            ...
            <tbody>
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="py-2 text-green-600 dark:text-green-400">None</td>
              ...
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="py-2 text-yellow-600 dark:text-yellow-400">Minimal</td>
              ...
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="py-2 text-orange-600 dark:text-orange-400">Small</td>
              ...
              <tr>
                ...
                <td class="py-2 text-red-600 dark:text-red-400">Noticeable</td>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div class="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
            <h5 class="font-medium text-green-800 dark:text-green-200 mb-2">✅ Quantize When:</h5>
            <ul class="text-sm text-secondary space-y-1">
        ...
        <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg mb-6">
          ...
          <div class="space-y-2 text-sm">
            <div class="flex justify-between items-center p-2 bg-white dark:bg-gray-800 rounded">
              ...
              <span class="font-mono text-red-600 dark:text-red-400">~26 GB RAM ❌</span>
            </div>
            <div class="flex justify-between items-center p-2 bg-white dark:bg-gray-800 rounded">
              <span>8-bit quantized:</span>
              <span class="font-mono text-yellow-600 dark:text-yellow-400">~13 GB RAM ⚠️</span>
            </div>
            <div class="flex justify-between items-center p-2 bg-white dark:bg-gray-800 rounded">
              <span>4-bit quantized (Q4):</span>
              <span class="font-mono text-green-600 dark:text-green-400">~6.5 GB RAM ✅</span>
            </div>
          </div>
    ...
    <!-- References -->
    <div class="mt-12 pt-8 border-t dark:border-gray-700 text-sm text-tertiary">
