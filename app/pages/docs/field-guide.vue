<template>
  <div class="max-w-6xl mx-auto">
    <!-- Section: Field Guide -->
    <section id="field-guide" class="mb-12">
        ...
        <div class="space-y-8">
          ...
          <div class="border-l-4 border-blue-500 pl-4">
            ...
            <div class="text-sm bg-blue-50 dark:bg-blue-900/20 p-3 rounded">
              ...
              <ul class="list-disc list-inside mt-1 space-y-1">
                ...
                <li>Include context in the instruction if needed</li>
          ...
          <div class="border-l-4 border-gray-400 pl-4">
            ...
            <div class="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg mb-3">
              ...
              <ul class="list-disc list-inside text-sm text-secondary space-y-1">
                <li>Code that needs to be explained or refactored</li>
                <li>Error messages that need debugging</li>
                <li>Long context that shouldn't be in the main instruction</li>
          ...
          <div class="border-l-4 border-green-500 pl-4">
            ...
            <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg mb-3">
              ...
              <ul class="list-disc list-inside text-sm text-secondary space-y-1">
                <li><strong>Directly answers</strong> the instruction</li>
                <li><strong>Complete and thorough</strong> - doesn't leave the user hanging</li>
                <li><strong>Well-structured</strong> - uses formatting, lists, code blocks</li>
                <li><strong>Accurate</strong> - factually correct information</li>
                <li><strong>Appropriate tone</strong> - matches your desired style</li>
                <li><strong>Includes examples</strong> - shows, don't just tell</li>
            ...
            <div class="text-sm bg-red-50 dark:bg-red-900/20 p-3 rounded">
              ...
              <ul class="list-disc list-inside mt-1 space-y-1">
                <li>Too short or incomplete</li>
                <li>Doesn't actually answer the question</li>
                <li>Contains errors or bad advice</li>
      ...
      <div class="card mb-6">
        ...
        <div class="space-y-6">
          ...
          <div class="border-l-4 border-purple-400 pl-4">
            ...
            <p class="text-secondary mb-3">Organizes your dataset into topics.</p>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
              <div class="bg-gray-100 dark:bg-gray-800 p-2 rounded text-center">
                <strong>Coding</strong>
                <p class="text-xs text-secondary">Programming, debugging, architecture</p>
              </div>
              <div class="bg-gray-100 dark:bg-gray-800 p-2 rounded text-center">
                <strong>Explanation</strong>
                <p class="text-xs text-secondary">Concepts, how-tos, tutorials</p>
              </div>
              <div class="bg-gray-100 dark:bg-gray-800 p-2 rounded text-center">
                <strong>Analysis</strong>
                <p class="text-xs text-secondary">Data, reviews, debugging</p>
              </div>
              <div class="bg-gray-100 dark:bg-gray-800 p-2 rounded text-center">
                <strong>Writing</strong>
                <p class="text-xs text-secondary">Content, emails, docs</p>
              </div>
              <div class="bg-gray-100 dark:bg-gray-800 p-2 rounded text-center">
                <strong>Math</strong>
                <p class="text-xs text-secondary">Calculations, problems</p>
              </div>
              <div class="bg-gray-100 dark:bg-gray-800 p-2 rounded text-center">
                <strong>Science</strong>
                <p class="text-xs text-secondary">Scientific topics</p>
              </div>
              <div class="bg-gray-100 dark:bg-gray-800 p-2 rounded text-center col-span-2">
                <strong>General</strong>
                <p class="text-xs text-secondary">Everything else</p>
              </div>
            </div>
          </div>
          ...
          <!-- Quality Rating -->
          <div class="border-l-4 border-purple-400 pl-4">
            <h4 class="font-semibold mb-2">⭐ Quality Rating (1-5 Stars)</h4>
            <p class="text-secondary mb-3">Your assessment of how good this training example is.</p>
            <div class="space-y-2 text-sm">
              <div class="flex items-center gap-3">
                <span class="text-2xl">⭐</span>
                <div>
                  <strong>Poor</strong>
                  <p class="text-secondary">Major issues, shouldn't be used for training</p>
                </div>
              </div>
              <div class="flex items-center gap-3">
                <span class="text-2xl">⭐⭐</span>
                <div>
                  <strong>Fair</strong>
                  <p class="text-secondary">Significant problems, needs major revision</p>
                </div>
              </div>
              <div class="flex items-center gap-3">
                <span class="text-2xl">⭐⭐⭐</span>
                <div>
                  <strong>Good</strong>
                  <p class="text-secondary">Acceptable quality, could be improved</p>
                </div>
              </div>
              <div class="flex items-center gap-3">
                <span class="text-2xl">⭐⭐⭐⭐</span>
                <div>
                  ...
                  <p class="text-secondary">Solid example, minor improvements possible</p>
                </div>
              </div>
              <div class="flex items-center gap-3">
                <span class="text-2xl">⭐⭐⭐⭐⭐</span>
                <div>
                  ...
                  <p class="text-secondary">Perfect example, ideal for training</p>
                </div>
              </div>
            </div>
            <p class="text-sm text-tertiary mt-3">
          ...
          <!-- Tags -->
          <div class="border-l-4 border-purple-400 pl-4">
            <h4 class="font-semibold mb-2">🏷️ Tags</h4>
            <p class="text-secondary mb-3">Custom labels for filtering and organization.</p>
            ...
            <p class="text-sm text-tertiary">
              Add relevant keywords to make examples easier to find later.
            </p>
          </div>
          ...
          <div class="border-l-4 border-purple-400 pl-4">
            ...
            <div class="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded text-sm">
              ...
              <ul class="list-disc list-inside mt-1 space-y-1">
                <li>"Clear explanation with multiple examples - great for training"</li>
                <li>"Output needs more detail about error handling"</li>
                <li>"Imported from Claude conversation, needs review"</li>
                <li>"Perfect beginner example, covers common confusion"</li>
              </ul>
            </div>
          </div>
        </div>
