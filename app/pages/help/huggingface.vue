<template>
  <div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <h1 class="text-3xl font-bold mb-4">🤗 What is Hugging Face?</h1>
      <p class="text-xl text-gray-600">
        The "GitHub of AI" - where the machine learning community shares models, datasets, and tools
      </p>
    </div>
      ...
      <div class="space-y-4 text-gray-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
          <div class="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
            ...
            <h3 class="font-semibold mb-1">Pre-trained Models</h3>
    ...
    <div class="card mb-6">
      ...
      <div class="space-y-4">
        <div class="flex gap-4 items-start">
          ...
          <div>
            <h3 class="font-semibold mb-1">Access to Base Models</h3>
            <p class="text-gray-600">
              Download foundation models like LLaMA, Mistral, or GPT-2 to start your fine-tuning
            </p>
          </div>
        </div>
        ...
        <div class="flex gap-4 items-start">
          ...
          <div>
            <h3 class="font-semibold mb-1">Share Your Trained Models</h3>
            <p class="text-gray-600">
              After fine-tuning, upload your model so others can use it (or keep it private)
            </p>
          </div>
        </div>
        ...
        <div class="flex gap-4 items-start">
          ...
          <div>
            <h3 class="font-semibold mb-1">Community & Documentation</h3>
            <p class="text-gray-600">
              Extensive docs, tutorials, and a helpful community for beginners
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="card mb-6">
      ...
      <div class="space-y-4">
        ...
        <div class="p-4 bg-gray-50 rounded-lg">
          ...
          <p class="text-gray-600 text-sm">
            Python library for downloading and using models. The main tool for fine-tuning.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4 py-4">
          <div class="flex-1 text-center">
            ...
            <p class="text-xs text-gray-500">From Model Hub</p>
          </div>
          ...
          <div class="flex-1 text-center">
            ...
            <p class="text-xs text-gray-500">Use edukaAI!</p>
          </div>
          ...
          <div class="flex-1 text-center">
            ...
            <p class="text-xs text-gray-500">Train the model</p>
          </div>
          ...
          <div class="flex-1 text-center">
            ...
            <p class="text-xs text-gray-500">Share your model</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="space-y-3 text-gray-700">
        ...
        <ul class="space-y-2 ml-4">
          <li class="flex items-start gap-2">
            ...
            <span>Requires Python knowledge and command line comfort</span>
          </li>
          <li class="flex items-start gap-2">
            <span class="text-yellow-600">•</span>
            <span>Fine-tuning requires GPU (either local or cloud)</span>
          </li>
          <li class="flex items-start gap-2">
            <span class="text-yellow-600">•</span>
            <span>Documentation is comprehensive but technical</span>
          </li>
          <li class="flex items-start gap-2">
            <span class="text-yellow-600">•</span>
        ...
        <p class="mt-4">
          ...
          <NuxtLink to="/help/axolotl" class="text-blue-600 hover:underline font-semibold">Axolotl</NuxtLink> 
      ...
      <div class="space-y-3">
        <a href="https://huggingface.co/docs/transformers/training" target="_blank" 
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600">Hugging Face's complete fine-tuning tutorial</p>
          </div>
          <span class="text-blue-600">→</span>
        </a>
        
        <a href="https://huggingface.co/models" target="_blank"
           class="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors">
          <span class="text-2xl">🤖</span>
          <div class="flex-1">
            <h3 class="font-semibold">Model Hub</h3>
            <p class="text-sm text-gray-600">Browse thousands of pre-trained models</p>
          </div>
          <span class="text-yellow-600">→</span>
        </a>
        ...
        <a href="https://huggingface.co/datasets" target="_blank"
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600">Find datasets for your training tasks</p>
          </div>
          <span class="text-green-600">→</span>
        </a>
        
        <NuxtLink to="/help/llm-training"
           class="flex items-center gap-3 p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
          <span class="text-2xl">🎓</span>
          <div class="flex-1">
            <h3 class="font-semibold">edukaAI: How LLM Training Works</h3>
            <p class="text-sm text-gray-600">Understand the fundamentals before you start</p>
          </div>
