  ...
  <div class="max-w-4xl mx-auto pb-20">
    ...
    <div v-if="term" class="mb-12">
      ...
      <div class="card">
        ...
        <div v-if="term.example" class="mt-6 p-4 bg-gray-50 rounded-lg">
    ...
    <div v-else class="text-center py-12">
      <p class="text-gray-500">Select a term from the glossary</p>
      <NuxtLink to="/help" class="btn-primary mt-4 inline-block">Back to Guide</NuxtLink>
    </div>
  </div>
</template>
