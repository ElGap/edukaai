  ...
  <div class="max-w-6xl mx-auto">
    <div class="mb-8">
      ...
      <p class="text-secondary">
        YAML-based configuration for easy LoRA training. Great for cloud GPUs and cross-platform
        workflows.
      </p>
    </div>
    ...
    <!-- Mac Warning -->
    <div
      class="card mb-6 bg-yellow-50 border-2 border-yellow-300 dark:bg-yellow-900/20 dark:border-yellow-700"
    >
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <ul class="text-sm text-secondary space-y-2 ml-4">
            <li>
              • <strong>Slower training:</strong> 10-30 minutes vs 16 seconds with MLX for the same
              task
            </li>
            <li>
              • <strong>No quantization:</strong> Cannot use 4-bit/8-bit models (uses 2-3x more RAM)
            </li>
            <li>
              • <strong>Missing optimizations:</strong> No Flash Attention, bitsandbytes, or QLoRA
            </li>
        ...
        <div class="info-box-green">
          ...
          <p class="text-sm text-secondary">Only if you specifically need:</p>
        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <NuxtLink to="/export" class="text-blue-600 hover:underline text-sm"
              >Go to Export → Select Alpaca format</NuxtLink
            >
          </div>
        </div>
...
axolotl --version</pre
        ...
        <div class="info-box-yellow">
          ...
          <p class="text-sm text-secondary mb-2">If you get build errors, it's likely due to:</p>
...
# }</pre
    ...
    <div class="card mb-6">
      ...
      <div class="space-y-4">
        <p class="text-sm text-secondary">
          Create <code class="bg-gray-100 dark:bg-gray-700 px-1">config.yaml</code> in your project
          folder. This is Mac-optimized (no 4-bit quantization).
        </p>
        ...
        <div class="info-box-green">
          ...
          <ol class="text-sm text-secondary space-y-1 ml-4">
            ...
            <li>
              ...
              <code class="bg-gray-100 dark:bg-gray-700 px-1">./model-output</code>
            </li>
          </ol>
        </div>
...
print(tokenizer.decode(outputs[0]))</pre
    ...
    <!-- Cloud GPU Option -->
    <div
      class="card mb-6 bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-300 dark:from-purple-900/20 dark:to-blue-900/20 dark:border-purple-700"
    >
      ...
      <div class="space-y-4">
        ...
        >
          <p class="text-secondary mb-3">
            <strong>Avoid the slow Mac training!</strong> Use cloud GPU for 5-10x faster training
            with full Axolotl features.
          </p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="info-box-green p-3">
              ...
              <a
                href="https://colab.research.google.com/github/axolotl-ai-cloud/axolotl/blob/main/examples/colab-notebooks/colab-axolotl-example.ipynb"
                target="_blank"
...
# Training will be 5-10x faster than Mac!</code></pre>
        ...
        <div class="info-box-yellow">
          ...
          <ul class="text-sm text-secondary space-y-1 ml-4">
            <li>
              • <strong>Full Axolotl features:</strong> 4-bit quantization, Flash Attention, QLoRA
            </li>
    ...
    <div class="card mb-6">
      ...
      <div class="space-y-4">
        <div class="info-box-blue">
          ...
          <p class="text-sm text-secondary mb-2">
            Unlike MLX which creates adapters, Axolotl creates a
            <strong>complete fine-tuned model</strong>:
          </p>
          <div class="bg-gray-800 text-gray-200 p-3 rounded text-sm">
            <pre>
model-output/
...
└── special_tokens_map.json</pre
        ...
        <div class="info-box-green">
          ...
          <p class="text-sm text-secondary">This is a complete, standalone model that can be:</p>
          <ul class="text-sm text-secondary space-y-1 ml-4 mt-2">
        ...
        <div class="info-box-purple">
          ...
          <NuxtLink
            ...
            class="inline-block bg-purple-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-purple-700"
          >
    ...
    <div class="card mb-6 bg-red-50 dark:bg-red-900/20">
      ...
      <div class="space-y-3 text-sm">
        ...
        <div class="p-3 bg-white dark:bg-gray-800 rounded-lg">
          ...
          <p class="text-secondary">
            Check Python version (need 3.9-3.11) and install Xcode tools:
            <code class="bg-gray-100 dark:bg-gray-700 px-1">xcode-select --install</code>
          </p>
        </div>
