<template>
  <div class="max-w-6xl mx-auto pb-20">
    ...
    <!-- Introduction -->
    <div class="card mb-8 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20">
      <h2 class="text-xl font-semibold mb-4">So You've Trained Your First Model...</h2>
      <p class="text-secondary leading-relaxed mb-4">
        Congratulations! You've fine-tuned your first LLM. But now you're staring at files like <code class="bg-gray-100 dark:bg-gray-700 px-1">adapters.safetensors</code>, wondering about "LoRA ranks," and trying to understand why everyone keeps talking about "quantizing" and "GGUF."
      </p>
    ...
    <section id="parameter-problem" class="mb-12">
      ...
      <div class="card">
        <h3 class="text-lg font-semibold mb-4 text-purple-700">Why We Can't Just Train Everything</h3>
        
        <p class="text-secondary mb-4 leading-relaxed">
          A modern LLM like Llama 3 has <strong>8 billion parameters</strong>. Each parameter is a 16-bit or 32-bit number.
        </p>
    ...
    <section id="lora" class="mb-12">
      ...
      <div class="card">
        ...
        <p class="text-secondary mb-4 leading-relaxed">
          <strong>LoRA</strong> (Low-Rank Adaptation) is a technique from a 2021 Microsoft Research paper. The core idea is simple:
        </p>

        <div class="info-box-gray mb-6">
          <h4 class="font-medium mb-4">The LoRA Insight</h4>
          <p class="text-secondary mb-4">
            Instead of updating all parameters in a weight matrix, we freeze the original weights and <strong>inject small, trainable matrices</strong> into the model.
          </p>
          
          <div class="bg-white dark:bg-gray-800 p-4 rounded-lg border dark:border-gray-700">
            <p class="font-mono text-sm mb-2 text-secondary">Original weight update:</p>
            <p class="font-mono text-sm bg-red-50 dark:bg-red-900/20 p-2 rounded mb-4">W_new = W_original + ΔW</p>
            <p class="font-mono text-sm mb-2 text-secondary">LoRA approach:</p>
            <p class="font-mono text-sm bg-green-50 dark:bg-green-900/20 p-2 rounded">W_new = W_original + (A × B)</p>
        ...
        <p class="text-secondary mb-4 leading-relaxed">
          The base model is a massive library of knowledge. When you fine-tune with LoRA, you're not rewriting the books—you're adding <strong>annotations in the margins</strong>.
        </p>
        ...
        <div class="info-box-blue">
          ...
          <p class="text-sm text-blue-800 dark:text-blue-200">
            Start with <strong>rank=8, alpha=16</strong>. Increase if model isn't learning; decrease if overfitting.
          </p>
        </div>
          ...
          <div class="info-box-gray">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-secondary">
                  Stores the base model in 4-bit precision while training LoRA adapters in full precision. <strong>Memory efficient:</strong> Train 65B models on single 48GB GPU. Uses "double quantization" for even more savings.
                </p>
          ...
          <div class="info-box-gray">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-secondary">
                  Decomposes weights into magnitude and direction, only applying LoRA to the direction component. <strong>Better stability:</strong> Prevents catastrophic forgetting better than standard LoRA.
                </p>
                <p class="text-xs text-tertiary mt-1">
          ...
          <div class="info-box-gray">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-secondary">
                  Freezes attention layers, only trains feed-forward networks. <strong>Faster training:</strong> Reduces trainable parameters by ~70% with minimal quality loss.
                </p>
                <p class="text-xs text-tertiary mt-1">
          ...
          <div class="info-box-gray">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-secondary">
                  Different learning rates for matrices A and B (B gets higher LR). <strong>Faster convergence:</strong> Reaches good results 2x faster than standard LoRA.
                </p>
                <p class="text-xs text-tertiary mt-1">
          ...
          <div class="info-box-gray">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-secondary">
                  Dynamically adjusts rank during training, allocating more parameters to important layers. <strong>Parameter efficient:</strong> Same performance with 30% fewer parameters.
                </p>
                <p class="text-xs text-tertiary mt-1">
          ...
          <div class="info-box-gray">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-secondary">
                  Train multiple LoRA adapters for different tasks, switch between them or merge them. <strong>Modular:</strong> One base model + multiple task-specific adapters.
                </p>
                <p class="text-xs text-tertiary mt-1">
        ...
        <div class="info-box-purple">
          <h4 class="font-medium text-purple-900 dark:text-purple-100 mb-2">Which Should You Use?</h4>
    ...
    <section id="adapters-vs-complete" class="mb-12">
      ...
      <div class="card">
        <h3 class="text-lg font-semibold mb-4 text-purple-700">What You Actually Get After Training</h3>
    ...
    <section id="quantization" class="mb-12">
      ...
      <div class="card">
        ...
        <p class="text-secondary mb-4 leading-relaxed">
          <strong>Quantization</strong> is the process of reducing the precision of model weights to save memory and speed up inference.
        </p>
        ...
        <h3 class="text-lg font-semibold mb-4 text-purple-700 mt-8">Advanced Training Optimizations</h3>
        ...
        <div class="space-y-4 mb-6">
          <div class="info-box-gray">
            ...
            <p class="text-sm text-secondary">
              Trades compute for memory. Instead of storing all activations, recomputes them during backward pass. <strong>Memory savings:</strong> Train models 3-4x larger with 30% slower training.
            </p>
          </div>
          ...
          <div class="info-box-gray">
            ...
            <p class="text-sm text-secondary">
              Simulate larger batch sizes by accumulating gradients over multiple steps. <strong>Use case:</strong> When you want batch size 32 but can only fit batch size 1 in memory.
            </p>
          </div>
          ...
          <div class="info-box-gray">
            ...
            <p class="text-sm text-secondary">
              Uses 16-bit floats for most operations, 32-bit for critical parts. <strong>Benefits:</strong> 2x faster training, 2x less memory, minimal quality loss.
            </p>
          </div>
          ...
          <div class="info-box-gray">
            ...
            <p class="text-sm text-secondary">
              Microsoft framework that partitions optimizer states, gradients, and parameters across GPUs. <strong>Scales to:</strong> Train models with trillions of parameters.
            </p>
          </div>
        </div>

        <div class="info-box-blue">
          <h4 class="font-medium text-blue-900 dark:text-blue-100 mb-2">Memory vs Speed Trade-offs</h4>
    ...
    <section id="gguf" class="mb-12">
      ...
      <div class="card">
        ...
        <p class="text-secondary mb-4 leading-relaxed">
          <strong>GGUF</strong> (GPT-Generated Unified Format) is a file format for storing quantized LLMs. It's the standard format for running models with llama.cpp, Ollama, and many other tools.
        </p>
...
ollama create my-model -f Modelfile</code></pre>
        ...
        <div class="space-y-6">
          <div>
            ...
            <div class="info-box-gray text-sm">
              ...
              <p><strong>3 epochs:</strong> Show each example three times (better learning, but risk of overfitting)</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="info-box-gray text-sm">
              <p><strong>Batch size 1:</strong> Update after every example (slower, but works with less memory)</p>
              <p><strong>Batch size 8:</strong> Update after 8 examples (faster, needs more memory)</p>
            </div>
          </div>
    ...
    <section id="advanced-topics" class="mb-12">
      ...
      <div class="card">
        ...
        <p class="text-secondary mb-4 leading-relaxed">
          <strong>Model merging</strong> combines multiple LoRA adapters or fine-tuned models into one. Popular in open-source community for creating "supermodels."
        </p>
        ...
        <div class="info-box-gray mb-6">
          ...
          <div class="space-y-3">
            <div>
              ...
              <p class="text-sm text-secondary">
                Weighted average: <code class="bg-gray-100 dark:bg-gray-700 px-1">W_merged = 0.7 × W_model1 + 0.3 × W_model2</code>
              </p>
            </div>
            <div>
              <p class="font-medium text-sm">Task Arithmetic</p>
              <p class="text-sm text-secondary">
                Add/subtract capabilities: <code class="bg-gray-100 dark:bg-gray-700 px-1">W_merged = W_base + (W_coding - W_base) + (W_math - W_base)</code>
              </p>
            </div>
            <div>
        ...
        <div class="info-box-red">
          <ul class="text-sm text-red-800 dark:text-red-200 space-y-2">
            <li><strong>Catastrophic Forgetting:</strong> Model forgets general knowledge while learning your task. Solution: Use lower learning rate, train for fewer epochs.</li>
            <li><strong>Overfitting:</strong> Model memorizes training data but can't generalize. Solution: More data, lower rank, early stopping.</li>
            <li><strong>Underfitting:</strong> Model doesn't learn your patterns. Solution: Higher rank, more epochs, higher learning rate.</li>
            <li><strong>Data Leakage:</strong> Test data in training set. Solution: Strict train/test split before any preprocessing.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <div class="card mb-8 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20">
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-start gap-3">
          ...
          <p class="text-secondary">Use <strong>LoRA</strong> to efficiently add your knowledge (only ~0.4% of parameters)</p>
        </div>
        <div class="flex items-start gap-3">
          <span class="text-xl">3️⃣</span>
          <p class="text-secondary">Get <strong>adapters</strong> (small files) or a <strong>complete model</strong> (self-contained)</p>
        </div>
        <div class="flex items-start gap-3">
          <span class="text-xl">4️⃣</span>
          <p class="text-secondary">Optionally <strong>fuse</strong> adapters into a complete model</p>
        </div>
        <div class="flex items-start gap-3">
          <span class="text-xl">5️⃣</span>
          <p class="text-secondary"><strong>Quantize</strong> to make it smaller (Q4_K_M recommended)</p>
        </div>
        <div class="flex items-start gap-3">
