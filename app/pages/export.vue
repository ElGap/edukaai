<template>
  <div class="max-w-6xl mx-auto">
    ...
    <div class="card mt-6">
      ...
      <div class="space-y-4">
        ...
        <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <p class="text-sm text-secondary mb-2">
            HuggingFace datasets format optimized for Unsloth. 2x faster training with 70% less
            VRAM.
          </p>
          <code class="text-xs bg-gray-800 text-gray-200 p-2 rounded block">
            { "text": "### Human: Who is Zorblax?\n\n### Assistant: Zorblax is a quantum
            gastronomer..." }
          </code>
    ...
    <!-- Next Steps -->
    <div
      class="card mt-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20"
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <NuxtLink
          to="/samples"
          class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow"
        >
